  ...
  return (
    <section id="contact" className="py-10 text-white">
      <div className="container mx-auto px-6 max-w-6xl text-start">
        ...
        <p className="text-gray-400 poppins-regular text-start mb-6">
        ...
        <a
          ...
          className="text-gray-300 hover:text-white text-start flex items-center mb-6"
        >
        ...
        <div className="flex justify-start space-x-6">
          <a
            ...
            className="text-gray-400 poppins-regular hover:text-white"
          >
            <FaInstagram size={24} />
          </a>
          <a
